  ...
  return (
    <div style={{ padding: '2rem', color: 'white'}}>
      ...
      {loading ? (
        ...
        <div style={{ flexWrap: 'wrap',display: 'flex', gap: '2rem', marginTop: '1rem', justifyContent: 'center', flexWrap: 'wrap' }}>
              ...
              {asteroids.map((asteroid) => {
                ...
                return (
                  <tr key={asteroid.id} style={{ borderBottom: '1px solid #555' }}>
                    ...
                    <td style={{ ...tdStyle, textAlign: 'right' }}>{asteroid.absolute_magnitude_h}</td>
                    <td style={{ ...tdStyle, textAlign: 'center', color: asteroid.is_potentially_hazardous_asteroid ? 'red' : 'lightgreen' }}>
